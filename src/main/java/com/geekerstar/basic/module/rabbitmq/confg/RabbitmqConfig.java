...
public class RabbitmqConfig {
    ...
    public Queue directOneQueue() {
        return new Queue(RabbitmqConstant.DIRECT_MODE_QUEUE_ONE);
    }
    ...
    public Queue queueTwo() {
        return new Queue(RabbitmqConstant.QUEUE_TWO);
    }
    ...
    public Queue queueThree() {
        return new Queue(RabbitmqConstant.QUEUE_THREE);
    }
    ...
    public FanoutExchange fanoutExchange() {
        return new FanoutExchange(RabbitmqConstant.FANOUT_MODE_QUEUE);
    }
    ...
    public TopicExchange topicExchange() {
        return new TopicExchange(RabbitmqConstant.TOPIC_MODE_QUEUE);
    }
    ...
    public Binding topicBinding2(Queue queueTwo, TopicExchange topicExchange) {
        return BindingBuilder.bind(queueTwo).to(topicExchange).with(RabbitmqConstant.TOPIC_ROUTING_KEY_TWO);
    }
    ...
    public Binding topicBinding3(Queue queueThree, TopicExchange topicExchange) {
        return BindingBuilder.bind(queueThree).to(topicExchange).with(RabbitmqConstant.TOPIC_ROUTING_KEY_THREE);
    }
    ...
    public CustomExchange delayExchange() {
        ...
        return new CustomExchange(RabbitmqConstant.DELAY_MODE_QUEUE, "x-delayed-message", true, false, args);
    }
